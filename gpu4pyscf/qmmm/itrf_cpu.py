    ...
    def grad_hcore_mm(self, dm, mol=None):
        ...
        if mm_mol.charge_model == 'gaussian':
            ...
            for i0, i1 in lib.prange(0, charges.size, blksize):
                ...
                j3c = df.incore.aux_e2(mol, fakemol, intor, aosym='s1',
                                       comp=3, cintopt=cintopt)
                g[i0:i1] = numpy.einsum('ipqk,qp->ik', j3c * charges[i0:i1], cupy.asnumpy(dm)).T
        else:
            ...
            for i, q in enumerate(charges):
                ...
                g[i] = (numpy.einsum('ij,xji->x', dm.get(), v) +
                        numpy.einsum('ij,xij->x', dm.get(), v.conj())) * -q
        return g
